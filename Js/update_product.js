...
/* btn.addEventListener('click', (e) =>{
    if(!validacion_texto.test(nombre.value) && !validacion_numero.test(precio.value) && !validacion_numero.test(codigo_barras.value)){
        e.preventDefault();
        alert('Error! El formulario no cumple con los requerimientos,');
        btn.disabled = true;
        btn.classList.replace('enabled-button-form', 'disabled-button-form');
 }
}); */